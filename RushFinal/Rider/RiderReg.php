...
<td>
Last Name:</td><td>
<input type="text" id="Rlname" name="Rlname" size=20 placeholder="Last name..." required><br /></td></tr>
<tr>
<td>
...
<td>
Address:</td><td>
<input type="text" id="Raddress" name="Raddress" size=50 placeholder="Home address..." required><br /></td></tr>
<tr>
<td>
Email:</td><td>
