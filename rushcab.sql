...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2021 at 10:33 PM
...
(1, '12345', 'asela', 'ravindu', '12345', '09871234', 'asel@gamol.com', 'asela', 'ruwani123', 'NO'),
...
(1, '1234', 'Malith', 'Test', '123', 'asdfrgtr', 'asdf@gmail', 'malith', 'malith123', 'YES'),
(2, '6789', 'dfghjk', 'dfgg', '09876543', 'sdfgefwefw', 'dn@gmail.com', 'ruwani', 'ruwani123', 'NO'),
...
(1, 1, 'Car', 'Toyota', 'premio', 'cbf-5466', '2021-02-07', 'NO'),
...
--
ALTER TABLE `driver_det`
  MODIFY `DID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
